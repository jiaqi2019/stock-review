...
class SampleProvider:
    def load(self, date: str) -> MarketSnapshot:
        sectors = [
            Sector("AI算力", 2.8, 9.6, 36.5, 980.0, 7, 84, 22, 106, 6.6, 18.0, 32.0),
            Sector("机器人", 1.9, 7.8, 18.2, 420.0, 5, 48, 19, 67, 7.5, 14.0, 26.0),
            Sector("电力设备", 0.7, 4.2, 6.1, 510.0, 2, 56, 44, 100, 2.0, 7.0, 13.0),
            Sector("消费电子", -0.3, 6.4, -2.0, 390.0, 1, 30, 51, 81, 1.2, 5.0, 9.0),
        ]
        stocks = [
